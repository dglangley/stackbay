...
/*
	getTerms(0,'id','terms');//initialize all $TERMS
	foreach ($TERMS as $id => $term) {
		$s = '';
		if ($id==$ORDER['termsid']) { $s = ' selected'; }
		$terms_list .= '<option value="'.$id.'"'.$s.'>'.$term['id']['terms'].'</option>'.chr(10);
	}
*/
...
?>
	...
	<div class="sidebar-section">
		<h4 class="section-header">Company</h4>
	...
	<div class="sidebar-section">
		<h4 class="section-header">Billing Address<?php if ($EDIT) { echo ' <a href="javascript:void(0);"><i class="fa fa-pencil"></i></a>'; } ?></h4>
...
<?php if (isset($ORDER['ship_to_id'])) { ?>
	<div class="sidebar-section">
		...
		<h4 class="section-header">Shipping Address<?php if ($EDIT) { echo ' <a href="javascript:void(0);"><i class="fa fa-pencil"></i></a>'; } ?></h4>
	...
	<div class="sidebar-section">
		...
		<h4 class="section-header">Service</h4>
...
<?php if (! $EDIT) { ?>
	...
	<p class="company_address" data-addressid=""><?=format_address($ORDER['bill_to_id']);?></p>
