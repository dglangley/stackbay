...
*/
	...
	if ($text_rows) {
		if ($list_type=='Demand') {
			...
			$text_rows = 'We have the following available:<br>'.chr(10).'<br>'.chr(10).$text_rows.'<br>'.chr(10).'<br>'.chr(10).
				'Standard 90-day warranty applies. All items are in stock and ready to ship unless otherwise noted. *Indicates item is original OEM equivalent marked as quoted.';
