...
-->
	                ...
	                <li><a href="/expenses.php?userid=<?=$U['id'];?>"><i class="fa fa-credit-card"></i> My Expenses</a></li>
					<?php if ($U['manager'] OR $U['admin'] OR $U['accounting']) { ?>
	                <li><a href="/timesheet.php"><i class="fa fa-clock-o"></i> Timesheets</a></li>
										...
										<div class="col-sm-6">
											<p>
												<div class="slider-frame">
													...
													<input type="radio" name="upload_type" class="upload-type hidden" value="Req" checked>
													<input type="radio" name="upload_type" class="upload-type hidden" value="Avail">
													<span data-off-text="Avail" data-on-text="Req" class="slider-button slider-mode" id="upload-slider">Req</span>
												</div>
