			...
			<div class="search-center">
			  <div class="form-group search-group">
				<div class="input-group">
	                ...
	                <input class="form-control" type="text" name="s" id="s" value="<?php echo trim($s); ?>" placeholder="Search..." <?php if ($_SERVER["PHP_SELF"]<>'/accounts.php' AND $_SERVER["PHP_SELF"]<>'/services.php' AND $_SERVER["PHP_SELF"]<>'/rma_add.php') { echo 'autofocus'; } ?> />
                	<span class="input-group-btn">
