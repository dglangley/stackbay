...
<body class="permission_denied">
  ...
  <div class="denied__wrapper">
    <h3>DENIED IN <span>SPACE</span> Looks like your access was denied. Please contact an admin for further assistance.</h3>
    ...
    <a href="http://stackbay.com/signup"><button class="denied__link">Go Home</button></a>
  </div>
