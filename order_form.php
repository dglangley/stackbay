	...
	<body class="sub-nav forms" id = "order_body" data-order-type="<?=$order_type?>" data-order-number="<?=$order_number?>">
		<div class="container-fluid pad-wrapper">
			...
			;">
				...
				<div class="col-md-4">
					<button class="btn-flat  <?=($order_number=="New")?'success':'default'?> pull-right btn-submit" id = "save_button" style="margin-top:2%;margin-bottom:2%;" data-validation="left-side-main">
